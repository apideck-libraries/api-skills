...
```bash
curl 'https://unify.apideck.com/connector/connectors/freeagent' \
...
[`quickbooks`](../quickbooks/), [`netsuite`](../netsuite/), [`sage-intacct`](../sage-intacct/), [`workday`](../workday/), [`xero`](../xero/), [`exact-online`](../exact-online/), [`freshbooks`](../freshbooks/), [`wave`](../wave/) *(beta)*, and 25 more.
