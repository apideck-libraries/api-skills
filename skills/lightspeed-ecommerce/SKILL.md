...
See [Lightspeed eCom (C-Series)'s API docs](https://developers.lightspeedhq.com) for available endpoints.
...
- [Lightspeed eCom (C-Series) official docs](https://developers.lightspeedhq.com)
